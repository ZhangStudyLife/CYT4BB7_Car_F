...
static const menu_air_param_definition_t s_air_param_definitions[] =
{
    ...
    MENU_AIR_PARAM(mode2_car_vel_error_lpf_hz, 1.2f, 0.1f, 0.1f, 20.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_accel_gain_pos, 4.5f, 0.1f, 0.0f, 15.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_accel_gain_neg, 4.5f, 0.1f, 0.0f, 15.0f, "Mode2 Img"),
