...
static const menu_air_param_definition_t s_air_param_definitions[] =
{
    ...
    MENU_AIR_PARAM(angle_dt, 0.002f, 0.0001f, 0.001f, 0.004f, "Basic"),
    MENU_AIR_PARAM(pos_z_dt, 0.02f, 0.001f, 0.005f, 0.05f, "Basic"),
    MENU_AIR_PARAM(vel_xy_dt, 0.01f, 0.001f, 0.005f, 0.05f, "Basic"),
    MENU_AIR_PARAM(vel_z_dt, 0.01f, 0.001f, 0.005f, 0.05f, "Basic"),
    MENU_AIR_PARAM(base_throttle, 3800.0f, 50.0f, 2500.0f, 5000.0f, "Basic"),
    MENU_AIR_PARAM(roll_mech_trim_deg, 0.5f, 0.1f, -10.0f, 10.0f, "Basic"),
    MENU_AIR_PARAM(pitch_mech_trim_deg, -1.5f, 0.1f, -10.0f, 10.0f, "Basic"),
    MENU_AIR_PARAM(angle_target_max, 30.0f, 1.0f, 10.0f, 30.0f, "Basic"),
    MENU_AIR_PARAM(g_fc_target_height_m, 1.1f, 0.05f, 0.7f, 1.5f, "Basic"),

    MENU_AIR_PARAM(roll_gyro_kp, 6.8f, 0.2f, 0.0f, 15.0f, "Gyro PID"),
    MENU_AIR_PARAM(roll_gyro_ki, 0.14f, 0.01f, 0.0f, 2.0f, "Gyro PID"),
    MENU_AIR_PARAM(roll_gyro_kd, 0.020f, 0.002f, 0.0f, 0.2f, "Gyro PID"),
    MENU_AIR_PARAM(roll_gyro_kff, 0.05f, 0.01f, 0.0f, 1.0f, "Gyro PID"),
    MENU_AIR_PARAM(roll_gyro_i_limit, 2000.0f, 50.0f, 0.0f, 3000.0f, "Gyro PID"),
    MENU_AIR_PARAM(roll_gyro_d_lpf, 60.0f, 2.0f, 0.0f, 150.0f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_kp, 6.8f, 0.2f, 0.0f, 15.0f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_ki, 0.18f, 0.01f, 0.0f, 2.0f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_kd, 0.014f, 0.002f, 0.0f, 0.2f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_kff, 0.05f, 0.01f, 0.0f, 1.0f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_i_limit, 2000.0f, 50.0f, 0.0f, 3000.0f, "Gyro PID"),
    MENU_AIR_PARAM(pitch_gyro_d_lpf, 60.0f, 2.0f, 0.0f, 150.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_kp, 13.0f, 0.5f, 0.0f, 30.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_ki, 4.8f, 0.2f, 0.0f, 15.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_kd, 0.0f, 0.01f, 0.0f, 2.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_kff, 0.0f, 0.01f, 0.0f, 1.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_i_limit, 2000.0f, 50.0f, 0.0f, 3000.0f, "Gyro PID"),
    MENU_AIR_PARAM(yaw_gyro_d_lpf, 30.0f, 1.0f, 0.0f, 150.0f, "Gyro PID"),

    MENU_AIR_PARAM(roll_angle_kp, 8.2f, 0.25f, 0.0f, 20.0f, "Angle PID"),
    MENU_AIR_PARAM(roll_angle_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(roll_angle_kd, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(roll_angle_kff, 0.42f, 0.02f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(roll_angle_i_limit, 80.0f, 5.0f, 0.0f, 300.0f, "Angle PID"),
    MENU_AIR_PARAM(roll_angle_d_lpf, 15.0f, 0.5f, 0.0f, 100.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_kp, 7.5f, 0.25f, 0.0f, 20.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_kd, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_kff, 0.42f, 0.02f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_i_limit, 80.0f, 5.0f, 0.0f, 300.0f, "Angle PID"),
    MENU_AIR_PARAM(pitch_angle_d_lpf, 15.0f, 0.5f, 0.0f, 100.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_kp, 5.4f, 0.25f, 0.0f, 20.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_kd, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_kff, 0.0f, 0.01f, 0.0f, 2.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_i_limit, 0.0f, 5.0f, 0.0f, 300.0f, "Angle PID"),
    MENU_AIR_PARAM(yaw_angle_d_lpf, 0.0f, 0.5f, 0.0f, 100.0f, "Angle PID"),

    MENU_AIR_PARAM(pos_z_kp, 1.3f, 0.05f, 0.0f, 5.0f, "Basic"),
    MENU_AIR_PARAM(vel_z_kp, 500.0f, 25.0f, 0.0f, 1000.0f, "Basic"),
    MENU_AIR_PARAM(vel_z_ki, 120.0f, 5.0f, 0.0f, 500.0f, "Basic"),
    MENU_AIR_PARAM(vel_z_i_limit, 700.0f, 25.0f, 0.0f, 2000.0f, "Basic"),

    MENU_AIR_PARAM(mode7_vel_x_kp, 0.2f, 0.01f, 0.0f, 2.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_x_ki, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_x_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_x_kff, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_x_i_limit, 3.0f, 0.1f, 0.0f, 20.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_x_d_lpf, 10.0f, 0.5f, 0.0f, 50.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_kp, 0.2f, 0.01f, 0.0f, 2.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_ki, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_kff, 0.0f, 0.001f, 0.0f, 1.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_i_limit, 3.0f, 0.1f, 0.0f, 20.0f, "Mode7 Vel"),
    MENU_AIR_PARAM(mode7_vel_y_d_lpf, 10.0f, 0.5f, 0.0f, 50.0f, "Mode7 Vel"),

    MENU_AIR_PARAM(pos_est_k_flow, 0.5f, 0.01f, 0.0f, 1.0f, "Estimation"),

    MENU_AIR_PARAM(mode5_img_kp, 0.28f, 0.01f, 0.0f, 1.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_img_kd, 0.18f, 0.01f, 0.0f, 1.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_img_d_lpf_hz, 1.0f, 0.05f, 0.1f, 20.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_vel_error_lpf_hz, 1.3f, 0.05f, 0.1f, 20.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_accel_gain_pos, 5.8f, 0.25f, 0.0f, 15.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_accel_gain_neg, 5.8f, 0.25f, 0.0f, 15.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_accel_ff, 4.0f, 0.2f, 0.0f, 15.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_turn_accel_ff, 3.4f, 0.2f, 0.0f, 15.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode5_car_turn_accel_lpf_hz, 2.9f, 0.1f, 0.1f, 20.0f, "Mode5 Img"),
    MENU_AIR_PARAM(mode8_img_x_kp, 2.4f,      0.1f, 0.0f, 10.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_kd, 0.0f, 0.02f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_kff, 0.0f, 0.01f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_i_limit, 0.0f, 1.0f, 0.0f, 100.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_x_d_lpf, 0.0f, 0.5f, 0.0f, 50.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_kp_car_x, 50.0f, 2.5f, 0.0f, 150.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_kp, 2.2f, 0.1f, 0.0f, 10.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_kd, 0.0f, 0.02f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_kff, 0.0f, 0.01f, 0.0f, 2.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_i_limit, 0.0f, 1.0f, 0.0f, 100.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_img_y_d_lpf, 0.0f, 0.5f, 0.0f, 50.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_kp_car_y, 65.0f, 2.5f, 0.0f, 150.0f, "Mode8 Img"),
    MENU_AIR_PARAM(mode8_vel_x_kp, 0.2f, 0.01f, 0.0f, 2.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_x_ki, 0.02f, 0.001f, 0.0f, 1.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_x_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_x_kff, 0.0f, 0.001f, 0.0f, 1.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_x_i_limit, 3.0f, 0.1f, 0.0f, 20.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_x_d_lpf, 10.0f, 0.5f, 0.0f, 50.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_y_kp, 0.2f, 0.01f, 0.0f, 2.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_y_ki, 0.02f, 0.001f, 0.0f, 1.0f, "Mode8 Vel"),
    MENU_AIR_PARAM(mode8_vel_y_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode8 Vel"),
    ...
    MENU_AIR_PARAM(mode1_img_d_lpf_hz, 1.0f, 0.05f, 0.1f, 20.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_vel_error_lpf_hz, 1.3f, 0.05f, 0.1f, 20.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_accel_gain_pos, 5.8f, 0.25f, 0.0f, 15.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_accel_gain_neg, 5.8f, 0.25f, 0.0f, 15.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_accel_ff, 4.0f, 0.2f, 0.0f, 15.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_turn_accel_ff, 3.4f, 0.2f, 0.0f, 15.0f, "Mode1 Img"),
    MENU_AIR_PARAM(mode1_car_turn_accel_lpf_hz, 2.9f, 0.1f, 0.1f, 20.0f, "Mode1 Img"),

    MENU_AIR_PARAM(mode2_img_kp, 0.28f, 0.01f, 0.0f, 1.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_img_kd, 0.18f, 0.01f, 0.0f, 1.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_img_d_lpf_hz, 1.0f, 0.05f, 0.1f, 20.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_vel_error_lpf_hz, 1.3f, 0.05f, 0.1f, 20.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_accel_gain_pos, 5.8f, 0.25f, 0.0f, 15.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_accel_gain_neg, 5.8f, 0.25f, 0.0f, 15.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_accel_ff, 4.0f, 0.2f, 0.0f, 15.0f, "Mode2 Img"),
    MENU_AIR_PARAM(mode2_car_turn_accel_ff, 3.4f, 0.2f, 0.0f, 15.0f, "Mode2 Img"),
    ...
    MENU_AIR_PARAM(mode4_img_d_lpf_hz, 1.0f, 0.05f, 0.1f, 20.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_car_vel_error_lpf_hz, 1.3f, 0.05f, 0.1f, 20.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_car_accel_gain_pos, 5.8f, 0.25f, 0.0f, 15.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_car_accel_gain_neg, 5.8f, 0.25f, 0.0f, 15.0f, "Mode4 Img"),
    MENU_AIR_PARAM(mode4_car_accel_ff, 4.0f, 0.2f, 0.0f, 15.0f, "Mode4 Img"),
    ...
    MENU_AIR_PARAM(mode3_img_x_kp, 2.0f, 0.1f, 0.0f, 10.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_kp2, 1.0f, 0.05f, 0.0f, 6.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_kd, 0.7f, 0.05f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_kff, 0.0f, 0.01f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_i_limit, 0.0f, 1.0f, 0.0f, 100.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_x_d_lpf, 1.5f, 0.1f, 0.0f, 50.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_kp_car_x, 60.0f, 2.5f, 0.0f, 150.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_kp, 2.0f, 0.1f, 0.0f, 10.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_kp2, 1.0f, 0.05f, 0.0f, 6.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_ki, 0.0f, 0.01f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_kd, 0.7f, 0.05f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_kff, 0.0f, 0.01f, 0.0f, 2.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_i_limit, 0.0f, 1.0f, 0.0f, 100.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_img_y_d_lpf, 1.5f, 0.1f, 0.0f, 50.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_kp_car_y, 70.0f, 2.5f, 0.0f, 150.0f, "Mode3 Img"),
    MENU_AIR_PARAM(mode3_vel_x_kp, 0.12f, 0.01f, 0.0f, 2.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_x_ki, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_x_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_x_kff, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_x_i_limit, 3.0f, 0.1f, 0.0f, 20.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_x_d_lpf, 10.0f, 0.5f, 0.0f, 50.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_kp, 0.12f, 0.01f, 0.0f, 2.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_ki, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_kd, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_kff, 0.0f, 0.001f, 0.0f, 1.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_i_limit, 3.0f, 0.1f, 0.0f, 20.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_vel_y_d_lpf, 10.0f, 0.5f, 0.0f, 50.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_turn_accel_ff_gain_x, 0.72f, 0.02f, 0.0f, 3.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_turn_accel_ff_gain_y, 0.30f, 0.02f, 0.0f, 3.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_turn_accel_ff_limit_x_deg, 18.0f, 0.5f, 0.0f, 20.0f, "Mode3 Vel"),
    MENU_AIR_PARAM(mode3_turn_accel_ff_limit_y_deg, 14.0f, 0.5f, 0.0f, 20.0f, "Mode3 Vel"),
